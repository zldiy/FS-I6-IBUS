...
uint16 crc_calculate(uint8 *buf,uint8 len)
{
    ...
    for(cntlen = 0;cntlen<len;cntlen++)
    {
        crc_register^=buf[cntlen];
...
//{
//    uint16 crc;
//    uint8 buf[6]={01, 03 ,00 ,00, 00, 02};
//    crc = CRC_GetModbus16(buf,6);
//    sprintf((char *)buf,"crc=%d %d",(int)(crc>>8)&0xff,(int)(crc&0xff));
//    UartSendStr(buf);
//}
*/
